...
<div class="container-fluid">
    <div class="row">
        <nav id="sidebarmenu" class="col-md-3 col-lg-2 s-md-block bg-light sidebar callapse">
            <div class="position-stycky pt-3">
...
<div class="form-floating">
  <input type="text" class="form-control" id="floatingInput" placeholder="Surname" name="id" value="<?php echo $user_data['surname'] ?>">
...
<br>
<button class="w-100 btn btn-lg btn-primary" type="sum=bmit" name="submit">Change</button>
