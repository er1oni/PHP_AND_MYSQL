...
function quickWriteToTheFile($message){
    file_put_contents("exmple.txt" $message.PHP_EOL);
    echo "message written to file using file+put+contents!<br>";
}

whriteToFile("this is sample log message!!");
quickWriteToTheFile("this will othervize everything whith a new message!!");
readFromFile();
